...
import projectWildlife from "@/assets/project-wildlife.jpg?url";
import projectHealth from "@/assets/project-health.png?url";
import projectCttAsset from "@/assets/mu-logo-2026.png?url";
import resumeAsset from "@/assets/resume.pdf?url";
    ...
    <div className="bg-brand-surface font-sans text-brand-primary">
      ...
      >
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center">
          <a
            href="#contact"
            className="bg-brand-primary text-white px-8 py-3 rounded-full font-medium hover:bg-brand-accent hover:text-brand-primary transition-all hover:-translate-y-1"
          >
            Get in touch
          </a>
          <a
            ...
            <div className="flex flex-col justify-center gap-6">
              ...
              <div className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm">
                ...
                <a
                  ...
                  className="mt-6 block text-center w-full border border-white/20 py-3 rounded-lg hover:bg-brand-accent hover:text-brand-primary hover:border-brand-accent transition-colors font-medium"
                >
